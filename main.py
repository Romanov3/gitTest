...
class MyGrid(Widget):
	...
	def btt_getalldata_press(self, username, password, save_in, opinion_csv):
		...
		# 	dirs = ''
		# 	for row in csv_data:
		# 		row_csv_data = ','.join(row)
		# 		dirs += row_csv_data
		# 		print('row: ', row_csv_data)
		# 	print('dirs:',dirs)
			# previous res (['<Project name>;<DNS - name server>;<Module name>;<File name, include location>'], 'C:/')
